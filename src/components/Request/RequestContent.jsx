  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response) {
        ...
        navigate("/historylist"); // Navigate to history list
      }
    } catch (error) {
    ...
    <div className="p-4 md:p-6 bg-white min-h-screen">
      ...
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg">
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border ${
                ...
                errors.requestDate ? "focus:ring-red-500" : "focus:ring-blue-500"
              }`}
            />
            {errors.requestDate && (
              <p className="text-red-500 text-sm mt-1">{errors.requestDate.message}</p>
            )}
          </div>
          ...
          {/* Completion Status */}
          <div>
            <label className="block text-gray-600 mb-2">Completion Status</label>
            <select
