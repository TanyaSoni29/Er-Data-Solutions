...
const DashboardContent = () => {
    ...
    const dummyTableData = stats?.companies || [
        { id: 1, name: 'Tam\'s Stationers', contactPerson: 'Corina McCoy', email: 'lorri73@gmail.com' },
        { id: 2, name: 'Pacific Stereo', contactPerson: 'Judith Rodriguez', email: 'k_pacheco@gmail.com' },
        { id: 3, name: 'Britches of Georgetown', contactPerson: 'Patricia Sanders', email: 'k.p.allen@aol.com' },
        { id: 4, name: 'Giant', contactPerson: 'Frances Swann', email: 'rodger913@aol.com' },
        { id: 5, name: 'Auto Works', contactPerson: 'Iva Ryan', email: 'dennis416@gmail.com' },
    ];
                        ...
                        {dummyTableData.map((company, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell align="center">
                                    ...
                                    <Button variant="outlined" color="warning" size="small" sx={{ mr: 1 }}>
                                        Edit
                                    </Button>
