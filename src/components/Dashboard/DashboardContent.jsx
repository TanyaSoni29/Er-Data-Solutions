...
const DashboardContent = () => {
	return (
		<div className='p-6 bg-white flex-1'>
			{/* Metrics Section */}
			<div className='flex justify-start items-start gap-4 mb-6 p-6'>
				<div className='bg-[#EDF0F3] p-4 rounded shadow w-60 h-36 flex justify-center items-center'>
				...
				<div className='bg-[#EDF0F3] p-4 rounded shadow w-[39rem] h-[20.2rem] flex flex-col justify-center items-center'>
