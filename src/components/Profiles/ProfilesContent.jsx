...
const ProfilesContent = () => {
  ...
  useEffect(() => {
    ...
    if (user?.image) {
      ...
      console.log("Profile Image URL:", `${import.meta.env.VITE_BASE_URL}/${user.image}`);
    ...
    <div className="p-8 bg-[#F8F9FD] min-h-screen">
      <div className="w-full mx-auto bg-[#F8F9FD] rounded-lg p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <form onSubmit={handleProfileSubmit(onSubmitProfile)}>
              ...
              <div className="mb-4">
                ...
                {profileErrors.contactPerson && (
                  <p className="text-red-500 text-sm">{profileErrors.contactPerson.message}</p>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                {profileErrors.mobileNo && (
                  <p className="text-red-500 text-sm">{profileErrors.mobileNo.message}</p>
                )}
              </div>
          ...
          {/* Password Form */}
          <div>
            <h2 className="text-xl font-semibold text-blue-600 mb-4">Change Password</h2>
